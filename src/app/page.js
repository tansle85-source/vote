  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[80vh] px-4 animate-fade-in" style={{ gap: '3rem' }}>
      ...
      <div className="text-center mt-12 mb-4" style={{ maxWidth: '800px' }}>
        <div style={{ display: 'inline-block', padding: '0.5rem 1rem', background: 'rgba(10, 130, 118, 0.1)', color: 'var(--accent-color)', borderRadius: '9999px', fontWeight: '600', marginBottom: '1.5rem', letterSpacing: '0.05em', textTransform: 'uppercase', fontSize: '0.85rem' }}>
          Official Voting Platform
        </div>
        <h1 style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: '1.1', marginBottom: '1.5rem', textShadow: '0 4px 20px rgba(10, 130, 118, 0.1)' }}>
          APTS 2026<br/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2" style={{ gap: '2rem', width: '100%', maxWidth: '900px' }}>
        <div className="glass-panel text-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem 2rem', background: 'linear-gradient(135deg, rgba(255,255,255,0.9), rgba(240,249,255,0.8))' }}>
          <div style={{ fontSize: '3.5rem', marginBottom: '1rem', background: '#fff', width: '80px', height: '80px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', boxShadow: '0 10px 25px rgba(10, 130, 118, 0.15)' }}>👨‍⚖️</div>
